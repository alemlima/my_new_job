...
describe 'Headhunter can comment on candidate profile' do
  ...
  scenario 'and must fill in the comment body' do
    candidate = Candidate.create!(email: 'ale@ale.com', password:'123456')
  ...
  scenario 'and can see all the comments for a candidate profile' do
    candidate = Candidate.create!(email: 'ale@ale.com', password:'123456')
    ...
    comment = Comment.create!(candidate_profile_id: candidate.id, headhunter_id: headhunter.id, body:'Bom candidato!')
    ...
    expect(page).to have_content('Comentário enviado com sucesso!')
    expect(page).to have_content('Comentário: Excelente candidato!')
    expect(page).to have_content('Comentário: Bom candidato!')
    expect(page).to have_content('Comentário enviado em:', count: 2)
    expect(page).to have_link('Voltar')
